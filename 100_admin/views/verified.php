      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
			...
			$sql = "SELECT * FROM API_user_account join user on API_user_account.usr_id=user.email join wallet1 on API_user_account.usr_id=wallet1.userid WHERE usr_paytm_isVarified='2' AND usr_bank_isVarified='2'";
