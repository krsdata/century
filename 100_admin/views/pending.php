...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Pending List (We do not allow our players from <text style="color: red;">Telangana, Orissa, Sikkim, Nagaland And Assam</text>)
      </h1>
	  <?php
	  if($_SESSION['TYPE'] == '1')
	  {
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
			...
			$sql = "SELECT * FROM API_user_account join user on API_user_account.usr_id=user.email join wallet1 on API_user_account.usr_id=wallet1.userid join states on API_user_account.usr_pan_state_id=states.state_id WHERE usr_paytm_isVarified='1' OR usr_bank_isVarified='1' LIMIT 0,20";
					...
					<tr>
					  ...
					  <td>
		                  ...
		                  <ul class="dropdown-menu" role="menu">
		                    ...
		                    <li><a href="#">DOB : <b><?php echo $rows['usr_pan_dob'];?></b></a></li>
		                    <li class="divider"></li>
					  ...
					  <td>
		                  ...
		                  <ul class="dropdown-menu" role="menu">
		                    ...
		                    <li><a href="#">Stat: <b><?php echo $rows['state_name'];?></b></a></li>
