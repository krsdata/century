      ...
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="../code/grand_league" method="post" autocomplete="off">
              ...
              <div class="row">
				...
				<div class="row">
                  <div class="col-md-12">
					  <label for="exampleInputEmail1">Marks Grade</label>
					  <table id="tableID1" class="table table-bordered table-striped">
							...
							<tbody id="dataTable1">
								<tr>
								  ...
								  <td><input type="number" class="form-control" name="start[]" value="" required=""></td>
								  <td><input type="number" class="form-control" name="end[]" value="" required=""></td>
								  <td><input type="number" class="form-control" name="prize[]" value="" required=""></td>
								</tr>
						</tbody>
						<tfoot>
						</tfoot>
