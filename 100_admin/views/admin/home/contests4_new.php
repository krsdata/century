...
echo '
<a href="contests1_new.php?trans1='.$match_id.'">
...
$query1="SELECT * FROM `user_team` WHERE `user_team_id`='$user12' and `match_id`='$match_id'";
$result1=mysqli_query($conn,$query1);
$rows1=mysqli_num_rows($result1);
while ($rows1 = mysqli_fetch_array($result1)) 
{
$plypointslive=floatval(trim($rows1['usr_team_earn_points']));
}
...
$query1="SELECT * FROM `user_team` WHERE `user_team_number`='$user12' and `match_id`='$match_id'";
$result1=mysqli_query($conn,$query1);
$rows1=mysqli_num_rows($result1);
while ($rows1 = mysqli_fetch_array($result1)) 
{
...
echo '
<a href="preview2_new.php?trans1='.$contest_id11.'&trans2='.$user12.'&trans3='.$match_id.'">
<div class="card btm mx-auto">
  <div class="row">
  <div class="col float-left" style="width: 255px;">
...
$query1="SELECT username,status  FROM `user` WHERE  email='$user1'";
$result1=mysqli_query($conn,$query1);
$rows1=mysqli_num_rows($result1);
while ($rows1 = mysqli_fetch_array($result1)) 
{
$user2=$rows1['username'];
$ustatus=$rows1['status'];
if ($ustatus == 3) {
	$bgcolor = '#7575ed';
}else{
	$bgcolor = '';
