...
session_start();
$match_id=$_GET['trans2'];
$contest_id11=$_GET['trans1'];
...
<?php
echo '
<a href="contests_new.php?trans1='.$match_id.'">
...
?>
<b>
http://centurysports.in/app_code/createRemoteTeam/<?php echo $_REQUEST['trans2'];?>/40
http://centurysports.in/app_code/joinContetsViaRemoteTeam/<?php echo $_REQUEST['trans2'];?>/<?php echo $_REQUEST['trans1'];?>/18</b>
</div>
</div>
...
$ty1=((intval($contest_id11)+$ty)*3)-$ty;
...
$query2="SELECT * FROM `user_team` WHERE `user_team_id`='$user12'";
$result2=mysqli_query($conn,$query2);
$rows2=mysqli_num_rows($result2);
while ($rows2 = mysqli_fetch_array($result2)) 
{
$tttcount=$rows2['user_team_number'];
}
...
$ty3=((intval($contest_id11)+$ty)*3)-$ty;
$ty4=((intval($user12)+$ty)*3)-$ty;


echo'
<a href="preview1_new.php?trans1='.$contest_id11.'&trans2='.$user12.'&trans3='.$match_id.'">
<div class="card btm mx-auto">
  <div class="row">
  <div class="col float-left" style="width: 255px;">
  ...
  <div class="col text-center" style="width: 150px;">
  <span class="tit" ><font color="orange">T'.$tttcount.'</font></span>
</div>
  <div class="col  text-right float-right">
...
<div class="card btm mx-auto">
  ...
  <div class="col text-center" style="width: 150px;">
  <span class="tit" >T'.$tttcount.'</span>
</div>
  <div class="col  text-right float-right">
  <span class="tit">--</span>
  </div>
