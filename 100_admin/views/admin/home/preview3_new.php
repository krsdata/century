...
<?php
echo '
<a href="contests5_new.php?trans1='.$contest_id.'&trans2='.$match_id.'">
...
$plypointslive = $rows['usr_team_earn_points'];
...
$query1="SELECT * FROM `totalpoints` WHERE `teamid`='$team_id' and `matchid`='$match_id'";
$result1=mysqli_query($conn,$query1);
$rows1=mysqli_num_rows($result1);
while ($rows1 = mysqli_fetch_array($result1)) 
{
