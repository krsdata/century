...
$link = "";
$user = $_POST['$id3']; //matchid
$email= $_POST['$amount3']; //contestid
$pass5=$_POST['$fill3']; //number of teams
$pass56=$_POST['$type3']; //multi - single
	...
	{ 
		...
		}else
		{
			...
			else
			{
				...
				$insert="INSERT INTO `user_team`(`user_id`, `match_id`, `players`, `caption`, `vice_caption`, `usr_team_earn_points`, `user_team_number`) VALUES ('$usssrs12','$user','$players','$cyu','$vcyu','0','$count11134')";
				...
				$count111 = mysqli_insert_id($conn);
				$contest_id111++;
