...
define('PAYTM_MERCHANT_KEY', 'h@ehZZ_@Jr@FNnmd'); //Change this constant's value with Merchant key received from Paytm.
define('PAYTM_MERCHANT_MID', 'wAiwyB82662467891327'); //Change this constant's value with MID (Merchant ID) received from Paytm.
define('PAYTM_MERCHANT_WEBSITE', 'DEFAULT'); //Change this constant's value with Website name received from Paytm.
define('PAYTM_CALLBACK_URL', "https://centurysports.in/app_code/V2_serviceController/paytmCallBack/");
